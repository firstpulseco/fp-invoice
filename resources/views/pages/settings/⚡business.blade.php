...
<div class="mx-auto w-full max-w-6xl py-6 sm:py-10">
    <header class="pb-8">
        ...
        <p class="mt-4 max-w-2xl text-zinc-600 dark:text-zinc-400">These details appear on new invoices. Existing invoices keep the information they were created with.</p>
    </header>
